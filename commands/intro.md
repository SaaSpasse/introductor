...
Read the Introductor skill file at `~/claude-code/introductor/skills/introductor/SKILL.md` and follow the workflow defined there. Also read the reference files in `~/claude-code/introductor/skills/introductor/references/` for best practices and templates.
